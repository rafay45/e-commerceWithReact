      ...
      >
        {products.map((product) => (
          ...
          >
            ...
            <button
              className="w-full bg-pink-600 text-white text-[11px] md:text-[16px] md:py-2 md:rounded-lg rounded hover:bg-transparent hover:text-pink-600 hover:border-2 hover:py-1.5 cursor-pointer transition"
            >
              Add to Cart
            </button>
          </div>
